...
<form action="pembayaran-update.php" method="post">
    ...
    <table>
        <tr>
            <td>Tanggal Bayar</td>
            <td>:</td>
            <td><input type="date" name="tgl_bayar" value="<?= $tgl; ?>" autofocus required></td>
        </tr>
        <tr>
            <td>Nama Siswa</td>
            <td>:</td>
        ...
        <tr>
            <td>Nama Kelas</td>
            <td>:</td>
            <td><input type="text" value="<?= $nama_kelas; ?>" readonly></td>
        </tr>
        <tr>
            <td>Jumlah Bayar</td>
            <td>:</td>
            <td><input type="text" value="<?= number_format($nominal); ?>" readonly></td>
        </tr>
        <tr>
            <td>Bulan Bayar</td>
            <td>:</td>
            <td>
                <select name="bulan_bayar" id="" required>
        ...
        <tr>
            <td><input type="submit" value="Update"> <a href="pembayaran.php">Cancel</a></td>
        </tr>
    </table>
</form>
</body>
